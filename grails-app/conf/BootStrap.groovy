...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def admin = User.findByUsername('admin')?:new User(username: 'admin', enabled: true, password: 'test', isNotificationEnabled: false )
		admin.save(failOnError: true)
		
		def user = User.findByUsername('test')?:new User(username: 'test', enabled: true, password: 'test', isNotificationEnabled: true)
		user.save(failOnError: true)
		
		def manuf = User.findByUsername('manuf')?:new User(username: 'manuf', enabled: true, password: 'test', isNotificationEnabled: false)
