		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<th class="header"><g:message code="productCategory.productSegment.label" default="Product Segment" /></th>
					...
					<g:each in="${productCategoryInstanceList}" var="productCategoryInstance">
						<tr>
							...
							<td>${fieldValue(bean: productCategoryInstance, field: "productSegment")}</td>
						
							<td class="link">
								<g:link action="show" id="${productCategoryInstance.id}" class="btn btn-small">Show &raquo;</g:link>
							</td>
						</tr>
					</g:each>
					</tbody>
				...
				<div class="pagination">
					<bootstrap:paginate total="${productCategoryInstanceTotal}" />
				</div>
			</div>
